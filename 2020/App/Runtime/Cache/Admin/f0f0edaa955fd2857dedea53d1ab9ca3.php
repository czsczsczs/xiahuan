...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" name="keywords"/>
            ...
            <!-- Bootstrap Core CSS -->
            <link href="/xiahuan/2020/Public/Static/Admin/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
            <!-- Custom CSS -->
            ...
            <link href="/xiahuan/2020/Public/Static/Admin/css/font-awesome.css" rel="stylesheet">
                <!-- jQuery -->
                <script src="/xiahuan/2020/Public/Static/Admin/js/jquery.min.js">
                </script>
                <!-- Bootstrap Core JavaScript -->
                <script src="/xiahuan/2020/Public/Static/Admin/js/bootstrap.min.js">
                </script>
            </link>
        </meta>
    </head>
