	...
	<div class="row-fluid"> 
        <div id="w">   
            <ul class="portfolio recent-work clearfix"> 
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li data-id="id-1" class="culture<?php echo ($row['id']); ?>">
                    <a href="<?php echo U('CultureHeritage/detail',array('id'=>$row['id']));?>">
