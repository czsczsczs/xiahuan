...
<div class="breadcrumbs margin-bottom-20">
    <div class="container">
        ...
        <ul class="pull-left breadcrumb">
            ...
            <li><a href="<?php echo U('Shop/index');?>">特色店鋪</a> <span class="divider">/</span></li>
        ...
        <div class="shop">
            <div class="span7" style="clear: right; ">
                <div id="myCarousel" class="carousel slide">
                    <div class="carousel-inner" style="margin-top: 15px; object-fit: contain;">
                        <?php if($images): if(is_array($images)): $key = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($key % 2 );++$key;?><div class="item <?php if($key == 1): ?>active<?php endif; ?>">
                                <img src="<?php echo ($row['savepath']); ?>" alt="" style="width:100%"/>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                        <?php else: ?>
                        <div class="item active">
                            <img src="<?php echo ($shop['cover']); ?>" alt="" style="width:100%"/>
                        </div><?php endif; ?>
                    </div>
            ...
            <?php if(empty($re_shop) != true): ?><div class="headline" style="display:block;margin:0px 0 25px 0;border-bottom:1px dotted #e4e9f0;clear: left;">
                ...
                <div class="swiper-container swiper-con-shop">
                    <ul class="thumbnails swiper-wrapper ulc">
                        <?php if(is_array($re_shop)): $i = 0; $__LIST__ = $re_shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?><li class="swiper-slide" style="height: 250px; width: 285px; margin-right: 10px;">
                            <a class="shop_a" href="<?php echo U(Shop/detail,array('id'=>$shop['id']));?>" style="text-align:center;background:#fcfcfc;display:inline-block;">
                                <em class="overflow-hidden"><img style="width:265px;height:180px;" src="<?php echo ($shop['cover_width_300']); ?>" alt="" /></em>
