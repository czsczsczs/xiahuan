...
<div class="breadcrumbs margin-bottom-20" style="height: auto;">
    <div class="container" style="padding: 0;">
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li class="active" style="color: #777;"><?php echo ($post['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
    ...
    <div class="row-fluid blog-page portflio_details">
        ...
        <div class="span9">
            ...
            <ul class="unstyled" style="font-size: 16px;">
                <li>
                    <span style="width:120px;display: inline-block;vertical-align: top;"><i class="icon-time color-green"></i> 開放時間：</span>
                    <span style="width: 200px;display: inline-block;vertical-align: top;"><?php echo ($post['business_hours']); ?></span>
                </li>
                <li>
                    <span style="width:120px;display: inline-block;vertical-align: top;"><i class="icon-map-marker color-green"></i> 具體地址：</span>
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/Posts/detail/id/<?php echo ($post['id']); ?>.html"
