...
<div class="breadcrumbs margin-bottom-40" style="height: auto;">
	<div class="container" style="padding: 0;">
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li><a href="<?php echo U('Active/index');?>">巡禮活動</a> <span class="divider">/</span></li>
...
<div class="container portfolio-item">
        ...
        <div>
            ...
            <ul class="unstyled" style="font-size: 16px">
            	<?php if($active['time']): ?><li>
                        <span style="color: #385A9F;width:120px;display: inline-block;vertical-align: top;"><i class="icon-time color-green"></i> 活動時間：</span>
                        <span style="width:350px;display: inline-block;vertical-align: top;"><?php echo ($active['time']); ?></span>
                    </li><?php endif; ?>
            	<li>
                    <span style="color: #385A9F;width:120px;display: inline-block;vertical-align: top;"><i class="icon-map-marker color-green"></i> 活動地點：</span>
                    <span style="width:350px;display: inline-block;vertical-align: top;"><?php echo ($active['address']); ?></span>
                </li>
            	<li>
                    <span style="color: #385A9F;width:120px;display: inline-block;vertical-align: top;"><i class="icon-tags color-green"></i> 活動簡介：</span>
                    <span style="width:350px;display: inline-block;vertical-align: top;"><?php echo ($active['other']); ?></span>
                </li>
            </ul>
        </div>
        
        <div id="allmap" class="span12 map">
            <script type="text/javascript" src="https://map.qq.com/api/js?v=2.exp&key=EOABZ-6CX65-4UIIM-QRI2W-YEXOO-ORB2Q"></script>
            
            <script>
                var center = new qq.maps.LatLng(<?php echo ($active['latitude']); ?>,<?php echo ($active['longitude']); ?>);
    ...
    <div class="row-fluid margin-bottom-40 swiper-container">
        <ul class="recent-work swiper-wrapper">
            <?php if(is_array($re_active)): $i = 0; $__LIST__ = $re_active;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$active_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" style="height:250px;">
                <a href="<?php echo U(Active/detail,array('id'=>$active_row['id']));?>">
                	<em class="overflow-hidden"><img style="height:180px;" src="<?php echo ($active_row['cover']); ?>" alt="" /></em>
                    <span>
                        <strong style="width:265px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo ($active_row['title']); ?></strong>
                        <i></i>
                    </span>
                </a>
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/Active/detail/id/<?php echo ($active['id']); ?>.html"
