...
<div class="breadcrumbs margin-bottom-20" style="height: auto;">
    <div class="container" style="padding: 0;">
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li class="active" style="color: #777;"><?php echo ($news['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
        ...
        <div class="span9">
            ...
            <div class="tab-content margin-bottom-20">
                <div class="tab-pane active" id="home">
                    ...
                    <h4 style="color: #385A9F;"><?php echo ($news['title']); ?></h4>
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/News/detail/id/<?php echo ($news['id']); ?>.html"
