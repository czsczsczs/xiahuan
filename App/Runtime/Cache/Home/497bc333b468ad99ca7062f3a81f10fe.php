                            ...
                            <li class="selectbox" style="margin-left: 10px">
                                <div class="select">
                                        <select id="selectbox2" onchange="window.location.href=options[selectedIndex].value">
                                            <option style="display:none;" value="http://macauonline.net/xiahuan/2020/Index/index.html">2022</option>
                                            <option value="http://macauonline.net/xiahuan/Index/index.html" >2022</option>
                                            <option value="http://macauonline.net/xiahuan/2020/Index/index.html">2021</option>
	...
	<div class="row-fluid"> 
        <div id="w"> 
            <ul class="thumbnails activity ulc">
                ...
                <li class="span3" link="<?php echo U('Shop/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'news'): ?>
                <li class="span3" link="<?php echo U('News/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'media'): ?>
                <li class="span3" link="<?php echo U('Media/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'media2'): ?>
                <li class="span3" link="<?php echo U('Media2/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'cultureHeritage'): ?>
                <li class="span3" link="<?php echo U('CultureHeritage/detail',array('id'=>$row['id']));?>"><?php endif; ?>
            		<div class="thumbnail-style thumbnail-kenburn">
            			...
            			<h3 style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
                            ...
                            <?php elseif($row['search_type'] == 'news'): ?>
                            <a class="hover-effect" href="<?php echo U('News/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'media'): ?>
                            <a class="hover-effect" href="<?php echo U('Media/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'media2'): ?>
                            <a class="hover-effect" href="<?php echo U('Media2/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'cultureHeritage'): ?>
                            <a class="hover-effect" href="<?php echo U('CultureHeritage/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a><?php endif; ?>
                        ...
                        <?php elseif($row['search_type'] == 'media2'): ?>
                        <p>類型:視頻集</p>
                        <?php elseif($row['search_type'] == 'culturehistory'): ?>
                        <p>類型:文化遺產</p><?php endif; ?>
