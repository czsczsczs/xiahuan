...
<div class="breadcrumbs margin-bottom-20" style="height: auto;">
    <div class="container" style="padding: 0;">
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li><a href="<?php echo U('Index/index');?>">社區魅力</a> <span class="divider">/</span></li>
            <li><a href="<?php echo U('CultureHeritage/index');?>">文化遺產</a> <span class="divider">/</span></li>
            <li class="active" style="color: #777;"><?php echo ($culturehistory['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
    ...
    <div class="row-fluid blog-page portflio_details">
        ...
        <div class="span9">
            ...
            <ul class="nav nav-tabs tabs">
                <li class="active"><a href="#home" data-toggle="tab"><?php echo ($culturehistory['title']); ?></a></li>
            </ul><!--/tabs-->

            <div class="tab-content margin-bottom-20">
                <div class="tab-pane active" id="home">
                    <!-- <img class="pull-left lft-img-margin img-width-200" src="<?php echo ($news['cover']); ?>" alt="" /> -->
                    <h4 style="color: #385A9F;"><?php echo ($culturehistory['title']); ?></h4>
                    <p><?php echo (htmlspecialchars_decode($culturehistory['content'])); ?></p>
                </div>
            </div><!--/tab-content-->
           <!-- <div class="title">
            ...
            <div class="headdiv">
                <span style="width: 100%;display: inline-block;">上一篇：
                    <?php if($before['title'] != NULL): ?><a href="<?php echo U(CultureHeritage/detail,array('id'=>$before['id']));?>" class="handover"><?php echo ($before['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
                <span style="width: 100%;display: inline-block;">下一篇：
                    <?php if($later['title'] != NULL): ?><a href="<?php echo U(CultureHeritage/detail,array('id'=>$later['id']));?>" class="handover"><?php echo ($later['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
            </div>
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/CultureHeritage/detail/id/<?php echo ($culturehistory['id']); ?>.html"
