...
<div class="breadcrumbs margin-bottom-20" style="height: auto;">
    <div class="container" style="padding: 0;" >
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;top: 0;padding: 0;margin: 0;">
            ...
            <li><a href="<?php echo U('StreetHistory/index');?>">街道故事</a> <span class="divider">/</span></li>
            <li class="active" style="color: #777;"><?php echo ($history['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/StreetHistory/detail/id/<?php echo ($history['id']); ?>.html"
