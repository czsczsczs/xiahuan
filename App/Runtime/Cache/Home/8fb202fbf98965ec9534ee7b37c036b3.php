...
<style type="text/css">
   ...
   /* #shopsmallimg .swiper-button-prev{
    left: -30px!important;;
    top: 75%!important;
   }
       
   #shopsmallimg .swiper-button-next{
...
<div class="breadcrumbs margin-bottom-40" style="height: auto;"> 
    <div class="container" style="padding: 0;">
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li>社區商業<span class="divider">/</span></li>
            <li id="shangye" class="active" style="color: #777;"><?php echo ($shop['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
<div class="container portfolio-item">
    ...
    <div class="row-fluid margin-bottom-20">
            <div class="span9">
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-arrow" id="prevnext">
                        <!-- <a data-slide="prev" href="#myCarousel" class="left carousel-control" style="z-index: 99"><i class="icon-angle-left"></i></a>
                        <a data-slide="next" href="#myCarousel" class="right carousel-control" style="z-index: 99"><i class="icon-angle-right"></i></a> -->
                    </div>
                ...
                <ul class="unstyled" style="font-size: 16px">
                    <li id="business">
						<span style="width:80px;vertical-align: top;color: #385A9F;">
                            <!-- <img src="/xiahuan/Public/Static/Home/img/opentime.png" style="width: 20px;">  -->
                            營業時間</span>：
						<span id="business_hours" style="width:210px;display: inline-block;vertical-align: top;"><?php echo ($shop['business_hours']); ?></span>
					</li>
                    <li>
                    ...
                    <li id="none">
						<span style="width:80px;letter-spacing: 2em;margin-right:-2em;vertical-align: top;color: #385A9F;">
                            <!-- <img src="/xiahuan/Public/Static/Home/img/yh.png" style="width: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                            優惠</span>：
						<span id="non" style="width:210px;display: inline-block;vertical-align: top;"><?php echo ($shop['special_offer']); ?></span>
					</li>
                </ul>
            </div>
            <div id="allmap" class="span12 map"></div>
            ...
            <div style="font-size: 18px;margin-bottom:15px ;padding-top: 10px;">
            ...
            <?php if(empty($re_shop) != true): ?><div class="headline" style="display:block;margin:0px 0 25px 0;border-bottom:1px dotted #e4e9f0;clear: left;">
                    <h3>猜你喜歡</h3>
                ...
                <div class="swiper-container swiper-con-shop">
                    <ul class="thumbnails swiper-wrapper ulc">
                        <?php if(is_array($re_shop)): $i = 0; $__LIST__ = $re_shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" style="height: 250px; width: 285px; margin-right: 10px;">
                            <a class="shop_a" href="<?php echo U(Shop/detail,array('id'=>$shop_row['id']));?>" style="text-align:center;background:#fcfcfc;display:inline-block;">
                                <em class="overflow-hidden"><img style="width:265px;height:180px;" src="<?php echo ($shop_row['cover_width_300']); ?>" alt="" /></em>
                                <span style="display: block;padding: 10px;border-bottom: solid 2px #eee;">
                                    <strong><?php echo ($shop_row['title']); ?></strong>
                                    <i></i>
                                </span>
                            </a>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
	//分享二维码
	var wz = "http://macauonline.net/xiahuan/Shop/detail/id/<?php echo ($shop['id']); ?>.html"
...
<script type="text/javascript">
	...
	var anchor = new qq.maps.Point(25, 40),
			...
			icon = new qq.maps.MarkerImage(
					"/xiahuan/Public/Static/Home/img/biaozhu.png",
					size,
					origin,
					anchor
			);
...
<script type="text/javascript">
    /*let li = $(".a li");
    li.click(function() {
        let src = $(this).find("img")[0].src; //获取图片绝对地址
         var srcs = $(this).find("img").attr("src"); //获取图片相对地址
        let ab=$("#bigimg").append("<img src=\""+src+"\">");
    });*/
