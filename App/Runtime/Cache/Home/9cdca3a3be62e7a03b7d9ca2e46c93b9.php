...
<div class="breadcrumbs margin-bottom-40" style="height: auto;">
    <div class="container" style="padding: 0;">
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li id="shangye" class="active" style="color: #777;"></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
        ...
        <div id="w">
            ...
            <ul class="portfolio recent-work clearfix">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li >
                    <a href="<?php echo U('Shop/detail',array('id'=>$row['id']));?>"  class="list-a">
                        <em class="overflow-hidden imgsize"><img src="<?php echo ($row['cover_width_300']); ?>" alt="" /></em>
                        <div class="titlesp">
                            <strong class="index_overflow" style="color: #385A9F;"><?php echo ($row['title']); ?></strong>
                        </div>
                    </a>
