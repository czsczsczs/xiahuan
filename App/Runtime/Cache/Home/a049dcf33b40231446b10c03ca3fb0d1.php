...
<div class="container"> 	
	<div class="row-fluid"> 
        <div id="w" class="swiper-container swiper-con-acindex">
            <ul class="swiper-wrapper thumbnails ulc">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li class="span6 swiper-slide" link="<?php echo U('Active/detail',array('id'=>$row['id']));?>" >
            		<div class="thumbnail-style activethumb">
            			<div class="thumbnail-img">
            				<img style="width: 100%;" src="<?php echo ($row['cover']); ?>" alt="" />					
            			</div>
                        ...
                        <?php if($row['time']): ?><p id="index_overflow" style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><span style="color:#385A9F;">活動時間：</span></p>
                        <p><?php echo ($row['time']); ?></p>
                        <?php else: ?>
                        <p>活動時間:無</p><?php endif; ?>
            			<p id="index_overflow" style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"><span style="color:#385A9F;">活動地點：</span></p>
                        <p><?php echo ($row['address']); ?></p>
                        <p id="index_overflow"><a style="text-decoration:none;" class="pull-right" href="<?php echo U('Active/detail',array('id'=>$row['id']));?>"><img style="max-width: 25px;" src="/xiahuan/Public/Static/Home/img/eye.png">查看詳情</a></p>
                    </div>
                    </div>
