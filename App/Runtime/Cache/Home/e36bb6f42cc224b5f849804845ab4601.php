...
<div class="breadcrumbs margin-bottom-40" style="height: auto;">
	<div class="container" style="padding: 0;">
        ...
        <ul class="pull-left breadcrumb" style="display: flex;align-items: center;flex-wrap: wrap;top: 0;padding: 0;margin: 0;">
            ...
            <li class="active" style="color: #777;">街道故事</li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
	...
	<div class="row-fluid">
        <div class="span9" id="w">
            ...
            <ul class="portfolio recent-work clearfix ulhe">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li class="swiper-slide sli" link="<?php echo U('StreetHistory/detail',array('id'=>$row['id']));?>">
                            ...
                            <div class="thumbnail-img" style="width: 100%;">
                                ...
                                <div style="width: 60%;float:right;">
                                    <h3 style="text-align-last: left;" id="index_overflow" title="<?php echo ($row['title']); ?>">
                                        <a style="color: #385A9F;" class="hover-effect txtstyle" href="<?php echo U('StreetHistory/detail',array('id'=>$row['id']));?>"><?php echo ($row['title']); ?></a>
                                    </h3>
                                    ...
                                    <p class="ppp" id="index_overflow"><a style="text-decoration:none;" class="pull-right" href="<?php echo U('StreetHistory/detail',array('id'=>$row['id']));?>"><img style="max-width: 25px;" src="/xiahuan/Public/Static/Home/img/eye.png">查看詳情</a></p>
                                </div>
