...
class ApiController extends BaseController 
{
    ...
    public function index()
    {
        ...
        foreach ($activity as $key1 => $value1) {
            $activity[$key1]['cover'] = 'http://macauonline.net'.$value1['cover_width_300'];
        ...
        foreach ($shop as $key2 => $value2) {
            $shop[$key2]['cover'] = 'http://macauonline.net'.$value2['cover_width_300'];
        ...
        foreach ($post as $key3 => $value3) {
            $post[$key3]['cover'] = 'http://macauonline.net'.$value3['cover_width_300'];
    ...
    public function lists($type)
    {
        ...
        foreach ($lists as $key => $value) {
            $lists[$key]['cover'] = 'http://macauonline.net'.$value['cover_width_300'];
...
// </p>
        ...
        if($data['images']){
            ...
            foreach ($imagesId as $key => $value) {
                ...
                $data['image'][$key]['savepath'] = 'http://macauonline.net/'.$file['save_path'];
            }
        }
    ...
    public function banner($id){
        ...
        $data = $this->slideModel->where($where)
            ->find();
        $data['image'] = 'http://macauonline.net'.$data['image'];
        return $this->ajaxReturn(success($data));
    }
